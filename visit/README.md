...
> Note as of December 2023: the data used in this tutorial has moved to `/lustre/orion/world-shared/stf007/msandov1/scivis_datasets`
...
2. Navigate to the `/lustre/orion/world-shared/stf007/msandov1/scivis_datasets/scivis_2018_deep_impact/yA31` directory in the `Path` box.
...
2. Navigate to `/lustre/orion/world-shared/stf007/msandov1/scivis_datasets/CCSN3D`
